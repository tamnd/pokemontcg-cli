...
Most of these come down to network reality or how pokemontcg serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

pokemontcg rate-limits like any public site. pokemontcg already paces
...
Where a surface is gated, pokemontcg reads a cookie or token you supply
...
`pokemontcg`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what pokemontcg actually did
