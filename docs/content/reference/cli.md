...
```
pokemontcg <command> [arguments] [flags]
```

Run `pokemontcg <command> --help` for the full flag list on any command. This
...
per operation you declare in `pokemontcg/domain.go`.
